...
@interface CouponStatusController ()

@end

@implementation CouponStatusController
...
-(void)loadData
{
    ...
    [SVProgressHUD show];
    [NetOperation getMyCouponWithUid:[GPUserManager sharedClient].user.userid key:[GPUserManager sharedClient].user.userkey  isused:self.flag index:[self.data count] size:10 withblock:^(NSArray *couplist, NSError *error) {
