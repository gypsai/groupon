...
@interface AboutPayController ()

@end

@implementation AboutPayController
...
- (void)viewDidLoad
{
    ...
    rec.size.height -=44;
    UIImageView *aboutv = [[UIImageView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 320.0f, 947.0f)];
    [aboutv setImage:[UIImage imageNamed:@"about_pay"]];
    
    UIScrollView *scro = [[UIScrollView alloc] initWithFrame:rec];
    scro.contentSize = CGSizeMake(320.0f, 947.0f);
