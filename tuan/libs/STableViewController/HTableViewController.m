...
- (void) scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (!isLoadingMore && canLoadMore) {
       ...
       // NSLog(@"++++contentSzie:%f scrollframe:%f scroll position:%f offset:%f",scrollView.contentSize.height,scrollView.frame.size.height,scrollPosition,scrollView.contentOffset.y);
