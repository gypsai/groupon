...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.paybtn.frame = CGRectMake(17.0f, 135.0f, 260.0f, 35.0f);
        [self.paybtn setTitle:@"验证码" forState:UIControlStateNormal];
        [self.paybtn setBackgroundImage:[UIImage imageNamed:@"pay_btn"] forState:UIControlStateNormal];
